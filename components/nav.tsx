    ...
    <>
      <nav className="av-nav">
        ...
        <div className="links">
          ...
          <Link href="/leaderboard" className={isActive("salon") ? "active" : ""}>Salón de la Fama</Link>
      ...
      <aside className={"av-mobile-panel" + (open ? " open" : "")}>
        ...
        <Link href="/leaderboard" className={isActive("salon") ? "active" : ""} onClick={close}>Salón de la Fama</Link>
